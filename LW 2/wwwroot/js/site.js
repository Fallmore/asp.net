...
let siteInfo = { "htmlName": "Index", "siteName": "Научные статьи" };
let imagesLink = ["../img/mainImage.png", "../img/image2.jpg", "../img/image.jpg", "../img/image3.png"];
let contentSection = [
    { "name": "Главная", "id": "Index" },
    { "name": "Статьи", "id": "States" }
];
...
let contentGallery = [
    {
        "thumbnail": "../img/Лисова Е.Н.png", "title": "Особенности профессионального становления студентов-психологов",
    ...
    {
        "thumbnail": "../img/Шарапаев Л. А.png", "title": "Касание предмета манипулятором робота под управлением нейросети",
    ...
    {
        "thumbnail": "../img/Слепченко и тд.png", "title": "Электрохимический контроль качества вод (обзор)",
...
let contentFooter = {
    "address": "г. Астрахань, АГТУ", "email": "info@ScienceState.ru",
